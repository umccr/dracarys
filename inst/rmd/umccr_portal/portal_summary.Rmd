...
lims_rds <- here::here(glue("nogit/data_portal/lims/2023-07-17.rds"))
# lims_raw <- glims_read()
# saveRDS(lims_raw, file = lims_rds)
lims_raw <- readr::read_rds(lims_rds)
pmeta <- here::here("nogit/data_portal/workflows/2023-07-17_subset.csv") |>
...
```{r vistime, fig.width=12, fig.height = 11}
p1 <- pmeta_sumy |>
