...
lims_rds <- here::here(glue("nogit/data_portal/lims/2023-06-19.rds"))
# lims_raw <- glims_read()
# saveRDS(lims_raw, file = lims_rds)
lims_raw <- readr::read_rds(lims_rds)
pmeta <- here::here("nogit/data_portal/workflows/2023-06-19_subset.csv") |>
...
```{r vistime, fig.width=13, fig.height = 13}
p1 <- pmeta_sumy |>
