...
# options(width = 150)
fmt1 <- "%Y-%m-%dT%H:%M:%S"
date_start <- as.POSIXct("2024-01-14T00:00:01", format = fmt1)
date_end <- as.POSIXct("2024-01-15T23:59:59", format = fmt1)
wf_order <- c(
  "bcl_convert",
...
wf_query <- 'WHERE "start" >= date(\'2024-01-13\') AND "start" <= date(\'2024-01-16\') ORDER BY "start" DESC;'
