tidy_add_args <- function(subp) {
  ...
  tidy$add_argument("-l", "--local_dir", help = glue("{emoji('inbox_tray')} If input is a GDS/S3 directory, download the recognisable files to this directory. Default: '<out_dir>/dracarys_<gds|s3>_sync'."))
