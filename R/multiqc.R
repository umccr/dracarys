...
MULTIQC_COLUMNS <- tibble::tribble(
  ...
  "dragen_alignment_qc", "Total input reads", "reads_total_input",
  "dragen_alignment_qc", "Total input reads pct", "reads_total_input_pct",
  ...
  "dragen_alignment_qc", "Total bases", "bases_total",
  "dragen_alignment_qc", "Total bases R1", "bases_total_r1",
  "dragen_alignment_qc", "Total bases R2", "bases_total_r2",
  ...
  "dragen_alignment_qc", "Total alignments", "alignments_total",
