...
MULTIQC_COLUMNS <- tibble::tribble(
  ...
  "dragen_umccrise", "percentage_of_properly_paired_reads_(%)", "samtools_percentage_of_properly_paired_reads_(%)",
  "dragen_umccrise", "reads_mapped_percent", "samtools_reads_mapped_pct",
  "dragen_umccrise", "reads_mapped_and_paired_percent", "samtools_reads_mapped_and_paired_percent",
  "dragen_umccrise", "reads_unmapped_percent", "samtools_reads_unmapped_percent",
  "dragen_umccrise", "reads_properly_paired_percent", "samtools_reads_properly_paired_percent",
  "dragen_umccrise", "reads_paired_percent", "samtools_reads_paired_percent",
  "dragen_umccrise", "reads_MQ0_percent", "samtools_reads_MQ0_percent",
  "dragen_umccrise", "reads_QC_failed_percent", "samtools_reads_QC_failed_percent",
  ...
  "bcbio_umccrise", "MODERATE_percent", "snpeff_moderate_percent",
  "bcbio_umccrise", "MODIFIER", "snpeff_modifier",
  "bcbio_umccrise", "MODIFIER_percent", "snpeff_modifier_percent",
  "bcbio_umccrise", "MISSENSE", "snpeff_missense",
  "bcbio_umccrise", "MISSENSE_percent", "snpeff_missense_percent",
  "bcbio_umccrise", "NONSENSE", "snpeff_nonsense",
  "bcbio_umccrise", "NONSENSE_percent", "snpeff_nonsense_percent",
  "bcbio_umccrise", "SILENT", "snpeff_silent",
  "bcbio_umccrise", "SILENT_percent", "snpeff_silent_percent",
  ...
  "bcbio_umccrise", "3_prime_UTR_variant_percent", "snpeff_3_prime_utr_variant_percent",
  "bcbio_umccrise", "5_prime_UTR_premature_start_codon_gain_variant", "snpeff_5_prime_utr_premature_start_codon_gain_variant",
  "bcbio_umccrise", "5_prime_UTR_premature_start_codon_gain_variant_percent", "snpeff_5_prime_utr_premature_start_codon_gain_variant_percent",
  "bcbio_umccrise", "5_prime_UTR_variant", "snpeff_5_prime_utr_variant",
  "bcbio_umccrise", "5_prime_UTR_variant_percent", "snpeff_5_prime_utr_variant_percent",
  "bcbio_umccrise", "TF_binding_site_variant", "snpeff_tf_binding_site_variant",
  "bcbio_umccrise", "TF_binding_site_variant_percent", "snpeff_tf_binding_site_variant_percent",
  "bcbio_umccrise", "conservative_inframe_deletion", "snpeff_conservative_inframe_deletion",
  "bcbio_umccrise", "conservative_inframe_deletion_percent", "snpeff_conservative_inframe_deletion_percent",
  "bcbio_umccrise", "conservative_inframe_insertion", "snpeff_conservative_inframe_insertion",
  "bcbio_umccrise", "conservative_inframe_insertion_percent", "snpeff_conservative_inframe_insertion_percent",
  "bcbio_umccrise", "disruptive_inframe_deletion", "snpeff_disruptive_inframe_deletion",
  "bcbio_umccrise", "disruptive_inframe_deletion_percent", "snpeff_disruptive_inframe_deletion_percent",
  "bcbio_umccrise", "disruptive_inframe_insertion", "snpeff_disruptive_inframe_insertion",
  "bcbio_umccrise", "disruptive_inframe_insertion_percent", "snpeff_disruptive_inframe_insertion_percent",
  "bcbio_umccrise", "downstream_gene_variant", "snpeff_downstream_gene_variant",
  "bcbio_umccrise", "downstream_gene_variant_percent", "snpeff_downstream_gene_variant_percent",
  "bcbio_umccrise", "frameshift_variant", "snpeff_frameshift_variant",
  "bcbio_umccrise", "frameshift_variant_percent", "snpeff_frameshift_variant_percent",
  "bcbio_umccrise", "initiator_codon_variant", "snpeff_initiator_codon_variant",
  "bcbio_umccrise", "initiator_codon_variant_percent", "snpeff_initiator_codon_variant_percent",
  "bcbio_umccrise", "intergenic_region", "snpeff_intergenic_region",
  "bcbio_umccrise", "intergenic_region_percent", "snpeff_intergenic_region_percent",
  "bcbio_umccrise", "intragenic_variant", "snpeff_intragenic_variant",
  "bcbio_umccrise", "intragenic_variant_percent", "snpeff_intragenic_variant_percent",
  "bcbio_umccrise", "intron_variant", "snpeff_intron_variant",
  "bcbio_umccrise", "intron_variant_percent", "snpeff_intron_variant_percent",
  "bcbio_umccrise", "missense_variant", "snpeff_missense_variant",
  "bcbio_umccrise", "missense_variant_percent", "snpeff_missense_variant_percent",
  "bcbio_umccrise", "non_coding_transcript_exon_variant", "snpeff_non_coding_transcript_exon_variant",
  "bcbio_umccrise", "non_coding_transcript_exon_variant_percent", "snpeff_non_coding_transcript_exon_variant_percent",
  "bcbio_umccrise", "non_coding_transcript_variant", "snpeff_non_coding_transcript_variant",
  "bcbio_umccrise", "non_coding_transcript_variant_percent", "snpeff_non_coding_transcript_variant_percent",
  "bcbio_umccrise", "protein_protein_contact", "snpeff_protein_protein_contact",
  "bcbio_umccrise", "protein_protein_contact_percent", "snpeff_protein_protein_contact_percent",
  "bcbio_umccrise", "sequence_feature", "snpeff_sequence_feature",
  "bcbio_umccrise", "sequence_feature_percent", "snpeff_sequence_feature_percent",
  "bcbio_umccrise", "splice_acceptor_variant", "snpeff_splice_acceptor_variant",
  "bcbio_umccrise", "splice_acceptor_variant_percent", "snpeff_splice_acceptor_variant_percent",
  "bcbio_umccrise", "splice_donor_variant", "snpeff_splice_donor_variant",
  "bcbio_umccrise", "splice_donor_variant_percent", "snpeff_splice_donor_variant_percent",
  "bcbio_umccrise", "splice_region_variant", "snpeff_splice_region_variant",
  "bcbio_umccrise", "splice_region_variant_percent", "snpeff_splice_region_variant_percent",
  "bcbio_umccrise", "start_lost", "snpeff_start_lost",
  "bcbio_umccrise", "start_lost_percent", "snpeff_start_lost_percent",
  "bcbio_umccrise", "stop_gained", "snpeff_stop_gained",
  "bcbio_umccrise", "stop_gained_percent", "snpeff_stop_gained_percent",
  "bcbio_umccrise", "stop_lost", "snpeff_stop_lost",
  "bcbio_umccrise", "stop_lost_percent", "snpeff_stop_lost_percent",
  "bcbio_umccrise", "structural_interaction_variant", "snpeff_structural_interaction_variant",
  "bcbio_umccrise", "structural_interaction_variant_percent", "snpeff_structural_interaction_variant_percent",
  "bcbio_umccrise", "synonymous_variant", "snpeff_synonymous_variant",
  "bcbio_umccrise", "synonymous_variant_percent", "snpeff_synonymous_variant_percent",
  "bcbio_umccrise", "upstream_gene_variant", "snpeff_upstream_gene_variant",
  "bcbio_umccrise", "upstream_gene_variant_percent", "snpeff_upstream_gene_variant_percent",
  "bcbio_umccrise", "DOWNSTREAM", "snpeff_downstream",
  "bcbio_umccrise", "DOWNSTREAM_percent", "snpeff_downstream_percent",
  "bcbio_umccrise", "EXON", "snpeff_exon",
  "bcbio_umccrise", "EXON_percent", "snpeff_exon_percent",
  "bcbio_umccrise", "INTERGENIC", "snpeff_intergenic",
  "bcbio_umccrise", "INTERGENIC_percent", "snpeff_intergenic_percent",
  "bcbio_umccrise", "INTRON", "snpeff_intron",
  "bcbio_umccrise", "INTRON_percent", "snpeff_intron_percent",
  "bcbio_umccrise", "MOTIF", "snpeff_motif",
  "bcbio_umccrise", "MOTIF_percent", "snpeff_motif_percent",
  "bcbio_umccrise", "SPLICE_SITE_ACCEPTOR", "snpeff_splice_site_acceptor",
  "bcbio_umccrise", "SPLICE_SITE_ACCEPTOR_percent", "snpeff_splice_site_acceptor_percent",
  "bcbio_umccrise", "SPLICE_SITE_DONOR", "snpeff_splice_site_donor",
  "bcbio_umccrise", "SPLICE_SITE_DONOR_percent", "snpeff_splice_site_donor_percent",
  "bcbio_umccrise", "SPLICE_SITE_REGION", "snpeff_splice_site_region",
  "bcbio_umccrise", "SPLICE_SITE_REGION_percent", "snpeff_splice_site_region_percent",
  "bcbio_umccrise", "TRANSCRIPT", "snpeff_transcript",
  "bcbio_umccrise", "TRANSCRIPT_percent", "snpeff_transcript_percent",
  "bcbio_umccrise", "UPSTREAM", "snpeff_upstream",
  "bcbio_umccrise", "UPSTREAM_percent", "snpeff_upstream_percent",
  "bcbio_umccrise", "UTR_3_PRIME", "snpeff_utr_3_prime",
  "bcbio_umccrise", "UTR_3_PRIME_percent", "snpeff_utr_3_prime_percent",
  "bcbio_umccrise", "UTR_5_PRIME", "snpeff_utr_5_prime",
  "bcbio_umccrise", "UTR_5_PRIME_percent", "snpeff_utr_5_prime_percent",
  ...
  "bcbio_umccrise", "TFBS_ablation_percent", "snpeff_tfbs_ablation_percent",
  "bcbio_umccrise", "bidirectional_gene_fusion", "snpeff_bidirectional_gene_fusion",
  "bcbio_umccrise", "bidirectional_gene_fusion_percent", "snpeff_bidirectional_gene_fusion_percent",
  "bcbio_umccrise", "gene_fusion", "snpeff_gene_fusion",
  "bcbio_umccrise", "gene_fusion_percent", "snpeff_gene_fusion_percent",
  "bcbio_umccrise", "stop_retained_variant", "snpeff_stop_retained_variant",
  "bcbio_umccrise", "stop_retained_variant_percent", "snpeff_stop_retained_variant_percent",
  "bcbio_umccrise", "GENE", "snpeff_gene",
  "bcbio_umccrise", "GENE_percent", "snpeff_gene_percent"
)
