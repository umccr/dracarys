...
MULTIQC_COLUMNS <- tibble::tribble(
  ...
  "dragen_umccrise", "reads_duplicated", "samtools_reads_duplicated",
  "dragen_umccrise", "reads_MQ0", "samtools_reads_MQ0",
  "dragen_umccrise", "reads_QC_failed", "samtools_reads_QC_failed",
  "dragen_umccrise", "non-primary_alignments", "samtools_non-primary_alignments",
  ...
  "dragen_umccrise", "reads_duplicated_percent", "samtools_reads_duplicated_percent",
