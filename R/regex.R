...
FILE_REGEX <- tibble::tribble(
  ...
  "msi\\.json\\.gz$", "tso/msi",
  "tmb\\.json\\.gz$", "tso/tmb",
  "TMB_Trace\\.json\\.gz$", "tso/tmb_trace_json",
  "TMB_Trace\\.tsv$", "tso/tmb_trace_tsv",
  "_CombinedVariantOutput\\.tsv$", "tso/combined_variant_output",
  "_Failed_Exon_coverage_QC\\.json\\.gz$", "tso/failed_exon_coverage_qc_json",
  "Failed_Exon_coverage_QC\\.txt$", "tso/failed_exon_coverage_qc_txt",
  "_Fusions\\.json\\.gz$", "tso/fusions_json",
  "_Fusions\\.csv$", "tso/fusions_csv",
  "MergedSmallVariantsAnnotated\\.json\\.gz$", "tso/merged_small_variants_annotated",
