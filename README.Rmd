...
{dracarys} supports most outputs from the following UMCCR workflows, including
their [MultiQC][multiqc-web] JSON output.

| Workflow   | Description |
|------------|-------------|
| bcl_convert | BCLConvert workflow (only MultiQC JSON) |
| tso_ctdna_tumor_only | UMCCR [ctDNA TSO500][cttso-web] workflow |
| wgs_alignment_qc | UMCCR [DRAGEN DNA][dragen-web] (alignment) |
| wts_tumor_only | | UMCCR [DRAGEN RNA][dragen-web] |
| wgs_tumor_normal | UMCCR Tumor/Normal DRAGEN workflow |
| umccrise | UMCCR [umccrise][umccrise-web] workflow|
